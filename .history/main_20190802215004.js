(function () {
  ...
  function checkWinner() {
      if
      (container[0].matches('.tic') && container[1].matches('.tic') && container[2].matches('.tic') ||
          container[3].matches('.tic') && container[4].matches('.tic') && container[5].matches('.tic') ||
          container[6].matches('.tic') && container[7].matches('.tic') && container[8].matches('.tic') ||
          container[0].matches('.tic') && container[3].matches('.tic') && container[6].matches('.tic') ||
          container[1].matches('.tic') && container[4].matches('.tic') && container[7].matches('.tic') ||
          container[2].matches('.tic') && container[5].matches('.tic') && container[8].matches('.tic') ||
          container[0].matches('.tic') && container[4].matches('.tic') && container[8].matches('.tic') ||
          container[2].matches('.tic') && container[4].matches('.tic') && container[6].matches('.tic')) {
          // winnerText.innerHTML = 'Победили крестики!';
          // winner.classList.add('active');
          alert('Победили крестики!')
      } else if
      (container[0].matches('.tac') && container[1].matches('.tac') && container[2].matches('.tac') ||
          container[3].matches('.tac') && container[4].matches('.tac') && container[5].matches('.tac') ||
          container[6].matches('.tac') && container[7].matches('.tac') && container[8].matches('.tac') ||
          container[0].matches('.tac') && container[3].matches('.tac') && container[6].matches('.tac') ||
          container[1].matches('.tac') && container[4].matches('.tac') && container[7].matches('.tac') ||
          container[2].matches('.tac') && container[5].matches('.tac') && container[8].matches('.tac') ||
          container[0].matches('.tac') && container[4].matches('.tac') && container[8].matches('.tac') ||
          container[2].matches('.tac') && container[4].matches('.tac') && container[6].matches('.tac')) {
