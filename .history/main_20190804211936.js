...
let App = {
  ...
  bindEvents(){
    document.addEventListener('load', this.onHashChange);
    document.addEventListener('hashchange', this.onHashChange);
  },
  cacheElements(){
    this.$templates = document.querySelectorAll('.container');
  }
  onHashChange(){
